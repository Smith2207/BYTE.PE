...
import { ESTADO_DEVOLUCION_ETIQUETA } from "@/components/devoluciones/estado-devolucion-badge";
import type { EstadoDevolucion } from "@/db/schema/enums";

const TODOS = "__todos__";

export function DevolucionesFiltros() {
  ...
  function actualizar(cambios: { q?: string; estado?: string }) {
    ...
    router.push(qs ? `/admin/devoluciones?${qs}` : "/admin/devoluciones");
  }
    ...
    <form onSubmit={onSubmit} className="mb-4 flex flex-wrap items-center gap-3">
      ...
      >
        ...
        <SelectContent>
          ...
          {(Object.keys(ESTADO_DEVOLUCION_ETIQUETA) as EstadoDevolucion[]).map((estado) => (
